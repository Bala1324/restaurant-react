...
const BookTable = () => {
    ...
    const bookTable = () => {
        ...
        axios.post("http://192.168.1.6:7000/api/v1/table/table-book", { date: bookingDate, location: selection.location, time: selection.time, person: selection.size }).then((res) => {
